...
public class MultiopticsItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    private static final int OVERLAY_ALPHA = 0xFF;

    public MultiopticsItem(Properties props, int humanityCost) {
        super(props);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Component.translatable("tooltip.createcybernetics.eyeupgrades_multioptics.energy")
    ...
    private static boolean poweredMultiopticsInstalled(PlayerCyberwareData data) {
        ...
        for (int idx = 0; idx < arr.length; idx++) {
            ...
            if (!(stack.getItem() instanceof MultiopticsItem)) {
                continue;
            }
    ...
    private static boolean enabledMultiopticsInstalledAndUnpowered(PlayerCyberwareData data) {
        if (data == null) {
            return false;
        }
        ...
        boolean hasEnabledMultioptics = false;
        boolean hasPoweredEnabledMultioptics = false;
        ...
        for (int idx = 0; idx < arr.length; idx++) {
            ...
            hasEnabledMultioptics = true;

            if (installed.isPowered()) {
                hasPoweredEnabledMultioptics = true;
            }
        }

        return hasEnabledMultioptics && !hasPoweredEnabledMultioptics;
    }
    ...
    public static final class PowerFailOverlayHooks {
        ...
        public static void onRenderGuiPost(RenderGuiEvent.Post event) {
            ...
            if (!enabledMultiopticsInstalledAndUnpowered(data)) {
                return;
            }
