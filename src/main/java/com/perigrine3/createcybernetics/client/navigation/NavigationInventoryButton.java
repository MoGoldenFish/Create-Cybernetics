...
public final class NavigationInventoryButton extends AbstractButton {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CreateCybernetics.MODID, "textures/gui/navchip_button.png");

    private final Runnable onPress;

    public NavigationInventoryButton(int x, int y, Runnable onPress) {
        super(x, y, 16, 16, Component.translatable("gui.createcybernetics.navigation.inventory_button"));
